...
@Component({
  selector: 'app-remote-controllers',
  templateUrl: './remote-controllers.component.html',
  styleUrls: ['./remote-controllers.component.css']
})
export class RemoteControllersComponent implements OnInit {
  allProducts: Product[] = [];
