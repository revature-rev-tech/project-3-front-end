...
@Component({
  selector: 'app-air-purifiers',
  templateUrl: './air-purifiers.component.html',
  styleUrls: ['./air-purifiers.component.css']
})
export class AirPurifiersComponent implements OnInit {
  allProducts: Product[] = [];
